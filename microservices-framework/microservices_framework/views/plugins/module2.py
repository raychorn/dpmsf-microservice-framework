...
__ID__ = '70dd81e5-961a-470e-9e88-63d828674757'  # place your Tenant ID here. you get this when you register as a Tenant.
...
@expose.endpoint(method='PUT|POST'.split("|"), API='sample-put')
